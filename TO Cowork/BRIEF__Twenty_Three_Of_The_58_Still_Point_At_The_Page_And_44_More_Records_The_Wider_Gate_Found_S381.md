...
## The one rule, again, with the test

A sentence may not have the page as its subject, and may not point at the page. "Here", "this", "throughout", "in one place", "told honestly", "worked through", "what matters here" all point at the page when they mean the article. The fix is to say the thing about the subject itself. Where the sentence only described the article, cut it.
...
1. **20-common-cognitive-biases-that-influence-your-decisions:** "Both kinds matter here..." Say what the two kinds are instead.
2. **dynamics-of-leading-effective-diplomatic-discussions:** "Both matter here..." Cut; let the next paragraph open.
3. **embracing-your-shadow-side:** "...too much to blur here." Suggest: "Most self-help content blurs the two together, and they are not the same thing."
4. **ethically-questionable-insights-from-the-robbers-cave-experiment:** "This is not a case against Muzafer Sherif..." "This" is the article. Suggest: "Muzafer Sherif was not a careless scientist, and the problems below are not his alone." (keep the facts that follow).
5. **examining-the-doll-test:** "...all matter here." Cut; the headings below already do this job.
6. **helping-people-help-themselves:** "...the one real distinction that matters here..." Suggest: "That gap between the two acts is the real distinction, and it asks something specific of anyone who wants to help well."
7. **jean-piagets-contributions-to-developmental-psychology:** the new line lost the old meaning (the article keeps to his ideas). Suggest: "His ideas stand on their own, apart from the story of his life."
8. **karpman-drama-triangle:** "...are what matter here." Cut.
9. **mimicking-aggression-insights-from-the-bobo-doll-experiment:** "All three names matter throughout..." Suggest: "All three names refer to the same study, which is why each one appears below."  If that still points, cut and keep the facts.
10. **perceptions-illusion-insights-from-the-halo-effect-experiment:** "The two studies stay separate here." Suggest: "Thorndike's study and the later one are two different studies, and they found different things."
11. **psychology-history-timeline:** "Here is a psychology history timeline built the slow way." Cut.
12. **the-importance-of-self-awareness:** "This is not a call to sit and stare at the wall for a week." Suggest: "Self-awareness is not sitting and staring at a wall for a week."
13. **the-lucifer-effect-10-lessons-from-philip-zimbardos-classic:** "...is kept here..." Suggest: "The ten lessons people usually repeat from the study do not all survive a close look."
14. **the-origin-of-cognitive-therapy:** "Not here." Cut.
15. **the-stages-of-change-model:** "That real story is honest..." does not make sense. Suggest: "The real story is messier than a tidy quote collection would ever admit."
16. **the-truth-about-eloquence:** "Both stories matter, told honestly..." Suggest: "There are two stories: the real one, from Aristotle, and the myth, from a badly stretched pair of 1967 studies."
17. **unraveling-apathy-insights-from-the-bystander-effect-study:** "Both halves matter, worked through honestly..." Cut, or state what the evidence found.
18. **unveiling-attachment-insights-from-harlows-monkey-experiments:** "Both halves belong together in one place..." Cut; mind the keyword density after.
19. **voices-of-vulnerability-insights-from-the-monster-study-experiment:** both new lines ("worth closing here", "Going deeper here"). Suggest for the second: "Mary Tudor's own role, and what her data actually showed, tell a different story."
20. **what-is-the-meaning-of-life-a-comprehensive-exploration:** "Each answer here is credited properly." Cut.
...
**Quote pages first (11): the quoted person is narrated.** Keep the standard source line; cut the narration, as you did on CQ018-056-1. Code's printout names the phrase: empathy-means-understanding-dissonance ("Gerard Egan adds"); what-happens-when-dialogue-becomes-disrespectful ("Kain describes"); why-mistakes-are-not-the-most-effective-way ("Kain tells"); why-mutual-respect-decides-if-a-relationship-survives ("Kain Ramsay says"); why-no-single-label-can-define-who-you-are ("Kain Ramsay explains"); why-no-teacher-can-make-you-learn ("Kain Ramsay explains"); why-we-dont-know-we-have-a-choice ("Kain describes"); why-we-end-up-going-round-and-round-in-circles ("Kain describes"); why-we-never-get-around-to-doing-anything ("Kain tells"); why-you-cant-trust-a-scared-person ("Kain Ramsay puts it"); wont-be-accomplished-at-all ("Gerard Egan explains").
...
One DONE file: part 1 as old line, new line, gate result; part 2 as slug, the flagged line, fixed (with the new line) or false alarm (with its one-line reason).
