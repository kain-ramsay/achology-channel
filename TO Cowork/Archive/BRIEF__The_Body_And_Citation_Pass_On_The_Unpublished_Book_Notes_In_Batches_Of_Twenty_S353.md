...
2. **One external link to the source.** In the body, one link to the book's or author's own reference page: the publisher's page for the book, the author's own site, or an encyclopaedic entry on the author or the book. Never an affiliate link in the body; the Amazon addresses with a tag are fields, not citations. Where a self-published book has no page but its retail listing, link the listing without any affiliate tag (Kain, S353, now DSRD 2 section 3.1). Where the record's Sourcing record already names such a page, use that one. Where no reputable page exists, name the record rather than linking to anything.
