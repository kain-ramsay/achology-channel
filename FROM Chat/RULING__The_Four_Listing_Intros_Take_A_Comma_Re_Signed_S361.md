...
**Answers:** `ASK__Sign_Off_On_Four_Dashes_Inside_Published_Cross_Category_Copy_S117.md`.
**Ruled by Kain, live, this session:** each dash becomes a comma; no other word changes. Replace lines 98 to 101 of `knowledge-hub-parts.php` with these exact strings, and correct DSRD 2 section 4.3 is Chat's, done this session.
...
That closes the last dash in the theme's PHP. One line back when shipped, with the version.
