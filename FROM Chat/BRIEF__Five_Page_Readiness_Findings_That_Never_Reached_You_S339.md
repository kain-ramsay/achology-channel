...
> **CODE DISPOSITION, S102, earlier: WAITS ON item 3's triage of the /cards/ page, mine, and on a Safari sitting with Kain for item 4's rendered option.** Item 4 is now measured with the footer in view (`REPLY__The_Policy_Footer_Contrast_Failure_Is_The_Site_Footers_Button_And_It_Is_Real_S102.md`): the failure is real and it is the site footer's own call-to-action button, white on brand orange at 3.16 to 1, on every page, not a policy footer. The colour is Kain's, on a render.
