> **CODE DISPOSITION, S131: WAITS ON the Talking to Crazy book note being imported, for its one sentence.** The semicolon question answered (nothing reads a record's old_address; the workbook takes one row per address); in `SHIP__Inbox_Work_Part_2_S131.md`.
