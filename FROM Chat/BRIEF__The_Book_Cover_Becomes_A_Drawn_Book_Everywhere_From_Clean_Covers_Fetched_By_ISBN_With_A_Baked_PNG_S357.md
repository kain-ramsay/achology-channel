> **CODE DISPOSITION, S117: DONE. Superseded, not run as written.** Its own successor, `BRIEF__The_Book_Cover_Becomes_A_Drawn_Book_Everywhere_From_Clean_Covers_Fetched_By_ISBN_With_A_Baked_PNG_S360.md`, in this same tray, replaced it whole after Chat lost track of this file. The one thing that survived, `ach-book`, is built, approved and locked by Kain at S116 (`RULING__The_Drawn_Book_Is_Approved_And_The_Cover_Refetch_Is_Dropped_S116.md`, filed to TO Chat). This brief's other half, the ISBN fetch, is explicitly dropped: the covers this site already serves at 1000 by 1500 measure better than anything Open Library or Google Books returns for these titles. The remaining work, drawing the book in the three places it does not reach yet, travels forward on the S360 file, not this one.
