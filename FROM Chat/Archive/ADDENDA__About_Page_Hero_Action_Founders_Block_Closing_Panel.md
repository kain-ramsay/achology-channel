...
- **Body, superseded S346 by Kain's own words, given live in the S103 sitting and carried on the page at theme v0.167.59.** Two paragraphs, Source Sans 3 17px, line height 1.65, brand dark. **These are his wording, character for character, and they are the operative text:**
  ...
  **What this replaced, kept so the change is readable rather than invisible.** The S237 text locked here until now read: "Achology was founded by Kain and Karen Ramsay in 2017, motivated by a simple frustration: psychology was often taught as academic knowledge, mainly as theoretical data to memorise rather than as practical wisdom for everyday use." and "Today, they run Achology from the central belt of Scotland, with members meeting them in person at mentorship sessions and events held throughout the year. Kain and Karen have been married since 2013 and have a daughter named Skye."

  **He worked it in three passes and trimmed his own text each time**, and the version above is the third and final one: "academic theory" became "theory", "everyday use" became "daily use", "the Royal Engineers, British Army" became "the British Army", and "married and have a daughter" became "married with a daughter". The two earlier passes were live for minutes each and are not the text.

  **Three facts leave with the old paragraph, named rather than lost quietly:** that they run Achology from the central belt of Scotland, that members meet them in person at mentorship sessions and events through the year, and the 2013 marriage date. His replacement carries their two backgrounds instead. **Whether any of the three is load-bearing elsewhere is carried as an open check**, not closed here: the founders' letter, the page's schema and DSRD 2's copy standards are the places to look, and none has been read against this yet.

  **A third wording was on the built page and no document records anyone ruling it (Code, S103).** It read: "Achology is run by Kain and Karen from their base in Scotland, with members attending monthly mentorship sessions and live events. They've been married since 2013 and have a young daughter named Skye." It matched neither this addendum nor Kain's new words, and it had been live for some time, close enough to the locked version to pass a glance. It is recorded because it is evidence that the About page's reconciliation against its own spec has a gap in it, and that gap is a piece of work rather than a footnote.
