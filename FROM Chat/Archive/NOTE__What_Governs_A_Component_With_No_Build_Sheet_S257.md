> **CODE DISPOSITION, S134: DONE.** Nothing owed by Code; the rule's home in Shared Rules section 4 is stock-take item 11 for Chat. Reconciled in `ASK__The_Stock_Take_Code_Side_And_What_Chat_Owes_S134.md`.
