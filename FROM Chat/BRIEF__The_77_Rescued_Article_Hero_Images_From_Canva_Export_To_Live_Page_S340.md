> **CODE DISPOSITION, S102: WAITS ON Kain's publishing word for the 74 drafts now on the install with their heroes, on Cowork's nine `featured_image` fields, and on nine pictures and map rows that do not exist yet.** Steps 1 to 5 are run for 74 of the 92 records (`REPORT__Seventy_Four_Rescued_Articles_Are_Drafts_With_Their_Heroes_Eighteen_Wait_S102.md`); the rendered half of step 4 runs at publication.
