> **CODE DISPOSITION, S111: DONE.** The foundations sitting it opens ran in full and Kain ruled nine decisions in Safari. The proposal it reviews is filed as `PROPOSAL__The_Type_Roles_And_The_Width_Family_Audited_From_What_Exists_S111.md`, built to this file's nine additions. Its rulings are in `RULING__The_Reading_Text_Is_Bigger_With_More_Space_And_It_Is_Decided_Before_The_Width_S111.md`, `RULING__The_Reading_Column_Becomes_800_At_The_New_Text_Size_S111.md` and `RULING__The_S111_Sitting_Decisions_Three_Onward_S111.md`, all in TO Chat. **Its section 1 was the most valuable sentence in the tray and nobody had read it that way:** the reading width is a property of the body role, derived from it. Kain stopped the sitting at decision one to say the same thing in his own words, and the order changed on the spot. Two of its additions are answered by his rulings rather than by the proposal: the twelve roles are eleven, because section-heading and block-heading collapsed into one, and `lead` now differs from `body` by weight alone.
