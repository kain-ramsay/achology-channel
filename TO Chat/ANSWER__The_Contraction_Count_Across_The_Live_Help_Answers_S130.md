...
**Answers:** part one of `BRIEF__A_Contraction_Check_In_The_Help_Answer_Gate_And_A_Count_Of_The_Live_Help_Bodies_S373.md`, and item 1 of `TASK_LIST__The_Thirteen_Finished_Cowork_Jobs_Waiting_On_You_In_Push_Order_S370.md`. Read only: no body touched.
**Board card:** Help section reader-first correction pass.

## The answer

- **Counted:** 217 records in the help-answer folder whose post_name is published on the install. The install has 250 published help pages; 33 of them have no record answering to their address, and the 30 records drafted at S376 are not live, so neither is counted.
- **No contraction at all: 154 of 217.**
- **Uncontracted forms outnumber contractions: 197 of 217.** Only 16 bodies carry at least as many contractions as stiff forms.
- **The corrected answers are in this count.** Cowork's reader-first pass (batches 01 to 09, S361 to S369) edited the records in place: 197 records carry an S362 to S369 line. So the 216 corrected answers waiting on the push are, measured, the stiff voice Kain ruled robotic at S373. Pushing them now and softening after would push them twice, which is what the task list's item 4 hold exists to prevent.
- **Proved both ways before trusting it:** the counter reads 0 on `achology-knowledge-hub-free-read` and a second, independent method agrees; on the approved exemplar, `HELP__cbt-practitioner-vs-cbt-therapist.md`, it reads 31 contractions and 0 stiff forms.

**Method:** body from `## Body` to the Related questions block or the first notes heading; link text and targets, quoted titles and the UKRLP line removed; a possessive 's is not counted, only 's after it, that, there, here, what and the like. Stiff forms: it is, you will, is not, do not, does not, cannot, you are, that is, there is, will not.

## By category, worst first

| Category | Answers | None at all | Contractions | Uncontracted forms |
|---|---|---|---|---|
| membership-and-access | 11 | 10 | 1 | 52 |
| achology-basics-and-identity | 32 | 28 | 4 | 166 |
| outcomes-and-expectations | 16 | 13 | 9 | 82 |
| refunds-and-billing | 10 | 8 | 9 | 54 |
| privacy-and-legal | 17 | 13 | 7 | 77 |
| comparisons-and-alternatives | 15 | 11 | 5 | 65 |
| curriculum-and-subjects | 7 | 5 | 3 | 25 |
| community-and-conduct | 10 | 7 | 7 | 62 |
| learning-experience | 13 | 9 | 5 | 51 |
| partnerships-and-press | 3 | 2 | 12 | 14 |
| certificates-cpd-accreditation | 20 | 13 | 16 | 86 |
| technical-help | 14 | 9 | 7 | 90 |
| getting-started | 8 | 5 | 5 | 37 |
| events-and-mentorship | 28 | 17 | 19 | 146 |
| pricing-and-payments | 13 | 4 | 23 | 40 |

Pricing and payments reads warmest; membership and access, and Achology basics and identity, read stiffest.

## For Kain, through Chat

Kain rules whether the section gets a softening pass before the push. If yes, that pass is Cowork's, on the records, and the push waits for it. Code has told Kain the count in the room this session.

## Every answer, worst first

| Answer | Category | Contractions | Uncontracted forms |
|---|---|---|---|
...
| what-is-achology | achology-basics-and-identity | 0 | 9 |
...
| achology-course-prerequisites-requirements | learning-experience | 2 | 8 |
...
| any-achology-courses-appear-more-than | curriculum-and-subjects | 2 | 7 |
...
| cancel-achology-membership-anytime | refunds-and-billing | 2 | 6 |
| is-achology-suitable-for-beginners | getting-started | 2 | 6 |
| achology-discussion-boundary-feels-unsafe | community-and-conduct | 1 | 4 |
| completed-achology-course-nothing-changed | learning-experience | 1 | 4 |
| difference-membership-courses-achology | membership-and-access | 1 | 4 |
| fix-achology-community-notification-problems | technical-help | 1 | 4 |
| guest-speakers-policy | privacy-and-legal | 1 | 4 |
| insurance-coverage-achology-qualifications | certificates-cpd-accreditation | 1 | 4 |
| pay-instalments-achology-courses | pricing-and-payments | 1 | 4 |
| valts-achology | events-and-mentorship | 1 | 4 |
| cips-when-need-them | events-and-mentorship | 2 | 5 |
| transfer-kain-ramsay-udemy-courses-achology | comparisons-and-alternatives | 2 | 5 |
| what-if-achology-courses-dont-work | outcomes-and-expectations | 2 | 5 |
| achology-accessibility-requirements | achology-basics-and-identity | 1 | 3 |
| achology-lifetime-access-explained | pricing-and-payments | 1 | 3 |
| achology-members-host-workshops-events | events-and-mentorship | 1 | 3 |
| achology-peer-learning-community-teaches | learning-experience | 1 | 3 |
| achology-vs-mindvalley-comparison | comparisons-and-alternatives | 1 | 3 |
| earn-cpd-credit-hosting-session-only | events-and-mentorship | 1 | 3 |
| best-browsers-devices-achology-community | technical-help | 3 | 5 |
| delete-achology-account-and-data | privacy-and-legal | 1 | 2 |
| where-should-i-start-with-achology | getting-started | 2 | 3 |
| achology-copyright-sharing-course-content | privacy-and-legal | 4 | 5 |
| is-achology-worth-the-money | pricing-and-payments | 4 | 5 |
| build-real-competence-achology | events-and-mentorship | 1 | 1 |
| host-own-achology-event | events-and-mentorship | 1 | 1 |
| who-verifies-achology-cpd-claims | certificates-cpd-accreditation | 1 | 1 |
| achology-anti-gatekeeping-pricing | pricing-and-payments | 3 | 3 |
| achology-pricing-versus-udemy-universities | pricing-and-payments | 3 | 3 |
| principle-based-reflective-discussion | events-and-mentorship | 8 | 8 |
| which-courses-included-each-school-bundle | curriculum-and-subjects | 1 | 0 |
| achology-payment-methods | pricing-and-payments | 2 | 1 |
| achology-no-transformation-promises | pricing-and-payments | 3 | 2 |
| what-achology-certificate-proves | certificates-cpd-accreditation | 4 | 1 |
| achology-code-character-conduct-ccac | community-and-conduct | 5 | 2 |
| difference-between-monthly-annual-achology-membership | pricing-and-payments | 5 | 1 |
| course-completion-vs-competence | outcomes-and-expectations | 6 | 2 |
| how-to-request-achology-refund | refunds-and-billing | 7 | 1 |
| six-achology-cpd-statuses | certificates-cpd-accreditation | 7 | 0 |
| using-achology-content-branding-materials | partnerships-and-press | 12 | 0 |

## OWED BACK

Nothing from Chat to close this. Part two (the gate check) is next on Code's list.
