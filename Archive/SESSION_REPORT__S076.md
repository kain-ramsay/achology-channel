> **CHAT DISPOSITION, S299:** read in full at the S299 open and consumed. Its two open decisions were already answered by Kain at the S298 close, both route 2: the source book resolved from slug to post ID at import, and the featured image resolved from filename at import. Its Benjamin Lockwood `line` field note closes the S297 open question: Kain ruled it stays as it is. Its DSRD 6 acronym point is carried by the ruling file beside it. No board card moved on this file. Archived.
