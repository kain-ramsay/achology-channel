# RECORD: Privacy Policy, chapter by chapter through DSRD 6

**From:** Claude Code, S230. **Date:** 2026-07-29. **Page:** https://achologytest.com/policies/privacy-policy/
...
| §2 Structure and headings | **Pass** | One H1 ("Privacy Policy"), 20 H2s, no skipped levels. Read alone the headings tell the page's story: they open with what the page covers, then run numbered sections in order. Matches the policy layout every other page in the family uses. |
| §3 Metadata | **Fail, one line** | Title 47 chars, unique, subject first. Description 148 chars. **Canonical absent**, which is the gate's single failure and is Rank Math configuration. Preview image is handled site-wide, per the standing ruling. |
