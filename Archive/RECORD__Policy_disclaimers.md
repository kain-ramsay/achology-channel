# RECORD: Disclaimers, chapter by chapter through DSRD 6

**From:** Claude Code, S230. **Date:** 2026-07-29. **Page:** https://achologytest.com/policies/disclaimers/
...
| §2 Structure and headings | **Pass** | One H1 ("Disclaimers"), 14 H2s, no skipped levels. Read alone the headings tell the page's story: they open with what the page covers, then run numbered sections in order. Matches the policy layout every other page in the family uses. |
| §3 Metadata | **Fail, one line** | Title 48 chars, unique, subject first. Description 135 chars. **Canonical absent**, which is the gate's single failure and is Rank Math configuration. Preview image is handled site-wide, per the standing ruling. |
...
4. Two of the three referred template items closed S043, shipped in v0.36.35 and verified live (the sticky header and the date-line grey); the footer announcement waits on the accent question to Chat. The §8 copy correction was applied S043 on v0.36.36 and verified on the live page, the page re-gated clean.
