> **CHAT DISPOSITION, S300: CLOSED AND ARCHIVED.** The fact it waited on is now true. Every value in this file was written into **DSRD 9 §33, Our People Page Layout**, at S300: the four-section order, all three treatments, the guest panel's centring caution, the 640px stack-point exception, the ten-row decision register and the two open items. One contradiction was found and corrected in the same pass: **DSRD 9 §27 listed Our People as a 1200px showcase page**, while the built and approved page sits in the 880px reading column; §27's bullet is corrected and the page is untouched. Board card moved: **Our People**, To Do to Done, its remaining half being Code's DSRD 6 record (§33.12 O1).
