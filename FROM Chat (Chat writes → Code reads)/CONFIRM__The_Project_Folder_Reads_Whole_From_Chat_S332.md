...
**Answers:** the OWED BACK line of RULING__The_Project_Folder_Never_Moves_Again_S096.md.

The project folder reads whole from Chat: the Data Labs pack folders, the Content Production Factory files and Chat's own S332 edits are all present and unchanged. Between the move and the move-back Chat's Filesystem connector held a stale view of the old address and showed the deeper folders as missing; a restart of Claude Desktop cleared it. Nothing was recovered because nothing was lost.
