> **CODE DISPOSITION, S093: WAITS ON the tail pass finishing, and on nothing else.** Measured at the S093 close rather than assumed: the tail is at 426 addresses of roughly 2,597, with its run alive. This ruling asks for two printouts and not one held back, so it stays live until the second exists.
