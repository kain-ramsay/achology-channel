> CODE DISPOSITION, S096: DONE. Withdrawn by Kain at S332 and archived at Code's S096 as item 4 of RULING__Nine_Answers_From_The_S332_Sitting_S332.md ordered; DSRD 9 section 22 is the page's standard and nothing is built to this file.

> **WITHDRAWN BY KAIN, S332.** This spec is superseded whole by DSRD 9 section 22 as it stands after Kain's later sittings with Code on the real page, which he approved by eye and which stand. Nothing is built to this file. Code archives it at S096 with this line at its head; its section 9 (the sitting) is carried on the eighteen instructor articles card and fires when those pages are out of the bin and live. Ruled in RULING__Nine_Answers_From_The_S332_Sitting_S332.md.
